...
BEGIN
    ...
    BEGIN
        BEGIN TRY
            ...
            -- INSERT AsisteD: un renglón por marcaje del grupo (todos los empleados)
...
END;
GO
PRINT '✓ SP dbo.sp_ProcessMarcajeQueue actualizado (modelo 4 movimientos por día, todos los empleados en AsisteD)';
GO
